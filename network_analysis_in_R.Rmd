...
```{r supreme_court_network_bipartite, echo = T, cache = T, warning = F, message = F, fig.widtth = 10, fig.height = 12}
...
- "Networks" by M.E.J. Newman. (In the first edition numbering) Chapter 7 "Measures and metrics" and Chapter 11 "Matrix algorithms and graph partitioning" overlap most with the underlying material of this tutorial. The book doesn't get into code (@newman10). 
